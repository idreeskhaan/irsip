...
jetmaxA_status.subscribe(function(message) {
  ...
  //slider_pos.unsubscribe();
  document.getElementById("jetmaxA_status_x").innerHTML = "x(mm): "+ parseInt(message.x);
  document.getElementById("jetmaxA_status_y").innerHTML = "y(mm): "+ parseInt(message.y);
  document.getElementById("jetmaxA_status_z").innerHTML = "z(mm): "+ parseInt(message.z);
});
...
jetmaxB_status.subscribe(function(message) {
  //console.log('Received message on ' + jetmaxA_status.name + ': ' + message.y);
  //slider_pos.unsubscribe();
  document.getElementById("jetmaxB_status_x").innerHTML = "x(mm): "+ parseInt(message.x);
  document.getElementById("jetmaxB_status_y").innerHTML = "y(mm): "+ parseInt(message.y);
  document.getElementById("jetmaxB_status_z").innerHTML = "z(mm): "+ parseInt(message.z);
});
